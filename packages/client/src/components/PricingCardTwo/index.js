...
const PricingCardTwo = (props) => {
  ...
  return (
    <Card className="bg-white">
      ...
      <div className="text-dark border-bottom text-center py-6 pricing-two position-relative m-0 justify-content-center ">
        <h2>
        ...
        <small className="d-block text-muted mt-3 h6  mt-2 ml-1 ">
          / per month
        </small>
      </div>
